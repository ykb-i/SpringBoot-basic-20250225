...
// - OncePerRequestFilter 추상클래스를 확장 구형하여 filter 클래스로 생성 가능
...
public class JwtAuthenticationFilter extends OncePerRequestFilter{
    ...
    private String getToken(HttpServletRequest request){
        ...
        // 1. request 객체 헤더에서 'Authorization' 필드의 값을 가져옴
        ...
        // 3. Authorization 필드 값에서 token만 추출
